...
import PositionSimulation from '../positionSimulation/PositionSimulation'
import H5door from '../h5door/H5door'
      ...
      <View className="debug-container">
        {!showDebugMenu && !hideHomeMenu && (
          <CoverView className='home-container'>
            <CoverImage
              className='home-img'
              src='https://storage.360buyimg.com/wxmini/cash/back.png
              '
